                    ...
                    <div>
                        <a-row>
                            ...
                            <a-textarea :auto-size="{ minRows: 1 }" v-model:value="item.value"
                                ...
                                :showCount="type == 'send' && item.type == 'str'"
                        ...
                        <a-row>
                            <a-space>
                                ...
                                <label v-if="item.type == 'str' && item.lengthType == 'DC'">{{ {
                                        "left": "左填", "right":
                                            "右填", "": "右填"
                                    }[item.fill] +
                    ...
                    <a-form>
                        ...
                        <a-form-item label="参数类型">
                            <a-radio-group v-model:value="param.type" button-style="solid" @change="paramTypeChange">
                                ...
                                <a-radio-button value="byte">byte</a-radio-button>
                                <a-radio-button value="int32">int32</a-radio-button>
                            </a-radio-group>
                        </a-form-item>
                        <a-form-item label="长度类型" v-if="param.type == 'str' && type == 'send'">
                        ...
                        <a-form-item label="长度/字节" v-if="param.type == 'str' && param.lengthType == 'DC'">
                            <a-input style="width:200px" type="number" :allowClear="true" v-model:value="param.length">
                            </a-input>
                        </a-form-item>
                        <a-form-item label="填充方向" v-if="param.type == 'str' && param.lengthType == 'DC'">
                        ...
                        <a-form-item v-if="type == 'send'" :label="'初始值' + (param.type != 'str' ? '(十进制)' : '')">
                            <a-input style="width:200px"
                                :disabled="param.type == 'str' && param.lengthType == 'DC' && !param.length"
...
export default {
    ...
    mounted() { },
    props: ["type", "params", "name", "addParamModalOk", "changeValue", "isXs", "delParam", "changeParamIndex"],
